...
import com.example.jpabook.domain.item.NotEnoughStockException;
...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문한 상품 종류 수가 정확해야 한다.",
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        assertThrows(NotEnoughStockException.class, () -> orderService.order(member.getId(), item.getId(), orderCount),"재고가 부족합니다.");
    //when
